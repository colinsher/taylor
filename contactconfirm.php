<!DOCTYPE html>
<?php
	$recipient = "thtetreau@gmail.com";
	$message = $_POST['message']."\n\nReply Email:  ".$_POST['email'];

	mail("colinjsherman@gmail.com","Contact Taylor",$message);
?>
<html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  <body>
  	...
  	<div class="container jumbotron" id="content">
  		<div class="row" id="aboutContent">
  			...
  			<div class="col-lg-10 col-md-10 col-sm-10 col xs-10 content forText" id="toFill">
